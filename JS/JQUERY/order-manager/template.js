...
$(document).ready(function () {
    ...
    var allsalesreport = $("#myslreportsf").DataTable({
        ...
        drawCallback: function (settings) {
            ...
            $(api.column(0).footer()).html("Total Card Payments: " + alldata.cardpayments + "<br/>  Total Online Payments: " + alldata.Onlinepayment + "<br/>  Total Cash Payments: " + alldata.Cashpayment);
        },
        footerCallback: function (row, data, start, end, display) {
            var api = this.api(),
                data;
            ...
            var pageTotal = pageTotal.toFixed(2);
            var total = total.toFixed(2);
            $(api.column(5).footer()).html(discountTotal + " ( " + totaldiscount + " total)");
            $(api.column(6).footer()).html(commisionTotal + " ( " + totalcommision + " total)");
            $(api.column(7).footer()).html(pageTotal + " ( " + total + " total)");
        },
    });
...
$(function () {
    ...
    $container.imagesLoaded(function () {
        $container.masonry({ itemSelector: ".grid-col", columnWidth: ".grid-sizer", percentPosition: true });
    });
